...
export default function SignUp() {
    ...
    const strengthLabel = ["", "Weak", "Fair", "Strong", "Solid"][strength];
    const strengthColor = [
        "",
        "bg-red-500",
        "bg-amber-500",
    ...
    return (
        <div className="min-h-screen bg-[#0F172A] flex flex-col items-center justify-center px-4 py-12 relative overflow-hidden font-mono">
            ...
            <div className="relative z-10 w-full max-w-[420px] bg-[#0F172A]/85 border border-[#1E293B] rounded-2xl px-8 py-10 backdrop-blur-xl">
                ...
                <p className="text-emerald-400 text-xs mb-1 opacity-80">~ $ create --new-account</p>
                <h1 className="text-slate-100 text-2xl font-bold tracking-tight mb-1 font-sans">Create account</h1>
                <p className="text-slate-500 text-sm mb-7 font-sans">Your portfolio ships in minutes</p>
                ...
                <div className="flex items-center gap-3 my-6">
                    ...
                    <span className="text-[#334155] text-[11px] whitespace-nowrap">or register manually</span>
                    <span className="flex-1 h-px bg-[#1E293B]" />
                </div>
                ...
                <form onSubmit={handleSubmit} className="flex flex-col gap-4">
                    ...
                    {/* Username + Email */}
                    {[
                        { name: "username", label: "Username", type: "text", placeholder: "gavinboris" },
                  ...
                  ${focused === field.name
                    ...
                    <div className="flex flex-col gap-1.5">
                        <label className="text-slate-400 text-xs tracking-wide">Password</label>
                        <input
                            name="password"
                            type="password"
                ...
                ${focused === "password"
                    ...
                    {/* Confirm Password */}
                    <div className="flex flex-col gap-1.5">
                        <label className="text-slate-400 text-xs tracking-wide">Confirm Password</label>
                        <input
                            name="confirm"
                            type="password"
                            placeholder="••••••••"
                ...
                ${focused === "confirm"
                        ...
                        />
                        {passwordMismatch && (
                            <span className="text-red-400 text-[11px]">Passwords do not match</span>
                        )}
                    </div>
                ...
                <p className="text-center text-[#334155] text-[11px] mt-4 font-sans leading-relaxed">
                    By signing up you agree to our{" "}
                    <Link to="/terms" className="text-indigo-400 hover:text-indigo-300 transition-colors">Terms</Link>{" "}
                    and{" "}
                    <Link to="/privacy" className="text-indigo-400 hover:text-indigo-300 transition-colors">Privacy Policy</Link>
                </p>

                <p className="text-center text-slate-500 text-sm mt-4 font-sans">
